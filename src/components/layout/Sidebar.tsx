...
export default function SidebarIsland() {
  ...
  return (
    <>
      <header className="bg-background bg- fixed top-0 left-0 z-50 h-20 w-full px-8 py-3">
        ...
        <div className="relative hidden h-full items-center xl:flex">
          {/* LEFT */}
          <a href="/" className="hover:text-primary z-10">
            <h1>Bernardusz</h1>
          </a>
      ...
      <div
        className={`bg-background fixed inset-0 top-0 right-0 z-50 flex w-full transition-transform duration-500 xl:hidden ${open ? "translate-x-[20vw]" : "translate-x-full"} `}
      >
        <aside className="bg-sidebar flex w-[82vw] flex-col justify-between gap-8 p-8">
          ...
          <div className="flex w-full flex-col gap-2">
            ...
            <hr className="w-full" />
            <div className="flex w-full flex-row justify-center gap-8 px-4">
              <a
